...
\newenvironment{fvnote}{\stepcounter{fvnum}\color{blue} [\,\textit{Note:}\,}{\textit{\,---\,end note\fvid}\,]\xspace\color{black}}


\newcommand{\fverror}[1]{\stepcounter{fvnum}\color{red}{[\,\textit{Error:}\, #1 \textit{\,---\,end error\fvid}\,]\xspace}\color{black}}
...
\newcommand{\fvins}[1]{{\color{orange}#1\fvid}\xspace }
\newcommand{\fvhl}[1]{\stepcounter{fvnum}\hl{#1 \fvid}}

\newcommand{\fventerexample} {\color{darkpurple}[\,\textit{Example:}\xspace}
\newcommand{\fvexitexample}{\stepcounter{fvnum}\textit{\,---\,end example\fvid}\,]\xspace\color{black}}

\newenvironment{fvexample}{\color{darkpurple}[\,\textit{Example:}\xspace}{\stepcounter{fvnum}\textit{\,---\,end example\fvid}\,]\xspace\color{black}}
