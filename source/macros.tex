...
\newcommand{\errorfv}[1]{\stepcounter{fvnum}\color{red}{[\,\textit{Error:}\, #1 \textit{\,---\,end error\fvid}\,]\xspace}\color{black}}

\newcommand{\marginfv}[1]{\stepcounter{fvnum}\sidepar{\smaller\color{blue}[\,\textit{Note:}\xspace #1 \textit{\,---\,end margin\fvid}\,]\xspace\color{black}}}
...
\newcommand{\hlfv}[1]{\stepcounter{fvnum}\hl{#1 \fvid}}

\newcommand{\enterexamplefv} {\color{darkpurple}[\,\textit{Example:}\xspace}
\newcommand{\exitexamplefv}{\stepcounter{fvnum}\textit{\,---\,end example\fvid}\,]\xspace\color{black}}
...
\newcommand{\paperfv}[1]{\href{http://wg21.link/#1}{#1}}
\newcommand{\cwgfv}[1]{\href{http://wg21.link/cwg#1}{cwg#1}}
