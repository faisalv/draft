...
%\newcommand{\notefv}[1]{\stepcounter{fvnum}\color{blue}{[\,\textit{Note:}\, #1 \textit{\,---\,end note\fvid}\,]\xspace}\color{black}}
...
%\newcommand{\fvmargin}[1]{\stepcounter{fvnum}\sidepar{\smaller\color{blue}[\,\textit{Note:}\xspace #1 \textit{\,---\,end margin\fvid}\,]\xspace\color{black}}}

\newcommand{\fvmargin}[1]{\stepcounter{fvnum}\sidepar{\smaller\color{blue}[\,\textit{Note:}\space #1 \textit{\,---\,end margin\fvid}\,]\space\color{black}}}
