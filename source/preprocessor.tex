 ...
 \begin{itemize}
 	...
 	\begin{itemize}
 		...
 		\tcode{\#define A(x,y) x,y\newline
 			\mbox{ \xspace\xspace A(A(1,2),3) ==> 1,2,3}\newline
 		}
 		...
 		\tcode{\#define A(x,y) A\newline
 			\#define B(b) b\newline
 			\mbox{ \xspace\xspace A() ==> ERROR!}\newline
 			\mbox{ \xspace\xspace B(A(1,2))() ==> A()}
 		}
 	\end{itemize}
 	\item Macro arguments are optional (replaced by 'placemarker' tokens), but the commas for non-ellipsis parameters are not optional i.e\newline
 		...
 		\mbox{ \xspace\xspace X(,) ==> "",""}\newline
 		\mbox{ \xspace\xspace X() ==> ERROR!}\newline
 		\mbox{ \xspace\xspace X(u,) ==> "u",""}\newline
 		\mbox{ \xspace\xspace X(,v) ==> "","v"}\newline}
 	...
 	\newline
 		\tcode{\#define A(x) a x\newline
 			   \#define B(x) b x\newline
 			   \mbox{\xspace\xspace A(B)(A)(B)(abc) ==> a b a b abc}
 			   \newline\newline
 			   \#define A2(x) x <a2> A1\newline
 			   \#define A1(x) x <a1> A2\newline
 			   \mbox{\xspace\xspace A1(2)(3)(4) ==> 2 <a1> 3 <a2> 4 <a1> A2}
 			   \mbox{\xspace\xspace A2(2)(3)(4) ==> 2 <a2> 3 <a1> 4 <a2> A1}
 			}
 \end{itemize}
}
...
\fvhl{Each occurrence of white space between the argument's preprocessing
