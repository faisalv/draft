...
\end{note}
\begin{fvnote} 
\href{http://lists.isocpp.org/core/2016/07/0772.php}{See discussion by Jeffrey and Richard reflector-cwg-772:}	
...
struct X { X *volatile p = this; };
void f(X x) { assert(x.p == &x); }
void g() { f({}); }
\end{codeblock} %
