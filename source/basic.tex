...
\item a template.
\end{itemize}
\marginfv{An extern function in an unnamed namespace has internal linkage.  \href{https://groups.google.com/a/isocpp.org/d/msg/std-discussion/oyLCkCUKpfU/vgw7DPMhFgAJ}{rsmith's example}}
\pnum
...
\marginfv{There is no semantic difference between a local function declaration declared with our without \tcode{extern} \href{http://lists.isocpp.org/core/2016/08/0826.php}{Hubert's reply}}
\begin{example}
\begin{codeblock}
static void f();
static int i = 0;               // \#1
void g() {
  ...
  {
    extern void f();            // internal linkage
    extern int i;               // \#3 external linkage, ill-formed \fvins{rationale: \cwgfv{426}}
  }
}
\end{codeblock}
