...
\usepackage{soul} % FV - used for highlighting
\usepackage{xstring} % FV - used for string processing, substr etc.
...
%%%%%%%%% Begin FV Debug Region to compile specific sections.
%% Comment out \end{document} and the section you want to compile
%\include{intro}
%\include{basic}
\include{expressions}
...
%%%%%%%%% End FV Debug Region to compile specific sections.
