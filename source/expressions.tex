...
\begin{fvfootnote}
	...
	1) n=0: \tcode{cv0=(), U=int const**} \newline
	2) n=1: \tcode{cv0=(), P0=(*), cv1=(), U=int const*}  \newline
	3) n=2: \tcode{cv0=(), P0=(*), cv1=(), P1=(*), cv2=(const) U=int}  \newline\newline	
...
\fvmargin{	
	...
	--- \tcode{struct X;}\newline
	--- \tcode{using U = const char (X::*())[10];}\newline
	--- \tcode{U const *const *const * p1 = (U ***const)0;}\newline
	--- \tcode{U **const *const * p2 = (U **const **)0;}\newline
	...
	--- \tcode{int volatile *const *pi = (int**)0;}\newline
	--- \tcode{int ** volatile *const *pi2 = \newline (int **volatile **)0;}\newline
