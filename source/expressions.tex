...
assuming that copy elision is performed \fvnote{Copy elision is manadatory for constant expressions \fvcwg{2022}},
are called 
...
\begin{fvnote} The reasons for resistance to clearly stating that constant expression evaluation occurs during  translation phase 7 and 8 is somewhat described in the following thread \href{http://lists.isocpp.org/core/2016/07/0741.php}{cwg-discussion-741}\end{fvnote}
